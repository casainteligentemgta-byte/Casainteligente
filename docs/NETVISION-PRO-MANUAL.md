...
> En la app: [`/nexus/vision/manual/explicativo`](/nexus/vision/manual/explicativo). Paso a paso: [cómo manejar NetVision](./NETVISION-PRO-USER-MANUAL.md). Campo: [guía instaladores](./NETVISION-PRO-INSTALLER-GUIDE.md).
