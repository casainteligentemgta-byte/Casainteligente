...
**Manual explicativo (visión de producto y uso):** [`NETVISION-PRO-MANUAL.md`](./NETVISION-PRO-MANUAL.md) — también en la app en [`/nexus/vision/manual`](/nexus/vision/manual).
