        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="relative">
                ...
                value={name}
                className="w-full bg-white/5 border border-white/10 rounded-xl px-10 py-3 text-white outline-none focus:border-blue-500 transition-all text-sm"
          ...
          <div>
            <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1 block">Correo Electrónico</label>
            <div className="relative">
          ...
          <div>
            ...
            <div className="relative">
                ...
                <select 
                    value={cargo}
                    className="w-full bg-white/5 border border-white/10 rounded-xl px-10 py-3 text-white outline-none focus:border-blue-500 transition-all text-sm appearance-none"
          ...
          <button 
            ...
            disabled={loading}
            className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-black py-4 rounded-xl flex items-center justify-center gap-2 hover:scale-[1.02] transition-transform active:scale-95 shadow-lg shadow-blue-500/20 mt-2"
          >
            {loading ? (
