...
import ResumenOficiosSolicitadosPanel from '@/components/rrhh/gestion-personal/ResumenOficiosSolicitadosPanel';
...
export default function RrhhGestionPersonalClient({
  ...
  const pendientesInner = (
    <>
      ...
      {hayFiltroAlcance && !loadingPending ? (
        <ResumenOficiosSolicitadosPanel
          soloPendientes={soloPendientes}
          totalPlazasPendientes={totalPlazasPendientes}
          pendingCount={pending.length}
          resumenOficiosSolicitados={resumenOficiosSolicitados}
          proyectoModuloFiltro={proyectoModuloFiltro}
          proyectoObraFiltro={proyectoObraFiltro}
          proyectoModuloIdsFiltro={proyectoModuloIdsFiltro}
          entidadFiltro={entidadFiltro}
          alcanceTodosProyectos={alcanceTodosProyectos}
          alcanceNombre={alcanceNombre}
        />
      ) : null}
