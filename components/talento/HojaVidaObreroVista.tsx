...
/**
 * Vista tipo documento con el esquema legal de hoja de vida del obrero (I. Identificación, etc.).
 */
export default function HojaVidaObreroVista({ hojaVidaLegal, className = '', planillaPatrono }: HojaVidaObreroVistaProps) {
  ...
  return (
    ...
    >
      ...
      <header className="border-2 border-black px-3 py-3 text-center">
        <h3 className="text-sm font-black uppercase tracking-wide text-black">{HOJA_VIDA_PLANILLA_TITULO}</h3>
        <p className="mt-1 text-[10px] font-medium leading-snug text-slate-800">{HOJA_VIDA_PLANILLA_SUBTITULO}</p>
