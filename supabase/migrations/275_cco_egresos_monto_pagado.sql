-- Migración combinada (275_cco_egresos_monto_pagado + 275_cco_snapshots_restauracion) para versión única en Supabase Preview.

-- --- 275_cco_egresos_monto_pagado.sql ---
