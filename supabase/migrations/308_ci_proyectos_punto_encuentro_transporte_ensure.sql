-- Asegura columnas de contrato laboral en ci_proyectos (117/115/124) + reload PostgREST.
-- Error típico: Could not find the 'punto_encuentro_transporte_contrato' column of 'ci_proyectos' in the schema cache
