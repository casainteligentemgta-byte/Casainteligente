-- 313: Fases técnicas editables y reutilizables en contratos / obras.
-- Catálogo global de textos usados + default por proyecto.
...
-- Semilla de fases comunes (construcción VE). ON CONFLICT no incrementa usos.
