-- Incluye solicitudes `in_progress` en la vista ejecutiva (además de `pending`).
...
comment on view public.global_labor_overview is
  'KPIs de mano de obra por proyecto: plazas pedidas (pending+in_progress), asignadas, cobertura %, solicitudes en tránsito y pool global de obreros disponibles.';
