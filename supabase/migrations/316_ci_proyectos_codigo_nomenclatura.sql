-- 316: Código de nomenclatura del proyecto (contratos, expedientes y documentos de obra).
-- Ej.: ASFJG → 2026-08-DIMA-ASFJG-0001
...
-- Si ya había obra_codigo y aún no hay nomenclatura, copiar (solo filas vacías).
