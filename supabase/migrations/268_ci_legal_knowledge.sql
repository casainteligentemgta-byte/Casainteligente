-- Migración combinada (268_ci_legal_knowledge + 268_contabilidad_compras_dedup_hash) para versión única en Supabase Preview.

-- --- 268_ci_legal_knowledge.sql ---
...
-- --- 268_contabilidad_compras_dedup_hash.sql ---
