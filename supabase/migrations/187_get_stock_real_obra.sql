-- Stock real consolidado por obra (fuente única: inventario_stock + inv_ubicaciones).
...
comment on function public.get_stock_real_obra is
  'Stock físico por material y ubicación de una obra (inventario_stock). Reemplaza lecturas legacy de global_inventory.stock_available.';
