-- Reparación idempotente: asegura procesar_procuras_lote (259) + recarga schema PostgREST.
-- Ejecutar en SQL Editor si al aprobar procura aparece PGRST202 / schema cache.
-- Requiere migración 257 (columna metadatos en ci_procura_estados_historial).
