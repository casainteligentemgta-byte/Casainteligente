        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className="flex rounded-lg border border-white/10 p-0.5">
            ...
            <button
              ...
              title="Misma ficha del obrero + patrono/obra (RRHH completa faltantes)"
            >
              Hoja de empleo
            </button>
          </div>
          {docTipo === 'hoja_empleo' ? (
            <p className="hidden text-[10px] text-zinc-500 sm:block max-w-[14rem]">
              Reusa la hoja de vida; RRHH completa patrono, obra y faltantes.
            </p>
          ) : null}
          {docTipo === 'hoja_empleo' ? (
            <button
