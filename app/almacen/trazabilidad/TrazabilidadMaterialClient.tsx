...
export default function TrazabilidadMaterialClient() {
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-zinc-500 font-bold uppercase text-xs tracking-widest">
              Ruta cronológica en inventario
            </p>
          </div>
        </div>
