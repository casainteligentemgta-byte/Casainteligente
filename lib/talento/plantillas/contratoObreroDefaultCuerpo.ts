...
Entre {{PATRON_RAZON_SOCIAL}}, sociedad mercantil domiciliada en {{PATRON_DOMICILIO}}, Municipio {{PATRON_MUNICIPIO}} del estado {{PATRON_ESTADO}}, {{PATRON_INSCRIPCION_RM}} representada en este acto por su {{REP_LEGAL_CARGO}} {{REP_LEGAL_ARTICULO_CIUDADANO}} {{REP_LEGAL_NOMBRE}}, {{REP_LEGAL_NACIONALIDAD}}, mayor de edad, titular de la cédula de Identidad número {{REP_LEGAL_CEDULA}}, hábil en derecho, {{REP_LEGAL_ESTADO_CIVIL}} y de este domicilio, quien a los efectos de este contrato se denominará LA ENTIDAD DE TRABAJO, por una parte y por la otra {{EMPLEADO_ARTICULO_CIUDADANO}} {{EMPLEADO_NOMBRE_COMPLETO}}, {{EMPLEADO_NACIONALIDAD}}, mayor de edad, titular de la cédula de identidad número {{EMPLEADO_CEDULA}}, hábil en derecho, {{EMPLEADO_ESTADO_CIVIL}} y de este domicilio; quien en lo sucesivo se denominará {{EMPLEADO_DENOMINACION}}, se ha convenido en celebrar, como en efecto se celebra, el presente Contrato de Trabajo para una Obra Determinada, conforme a lo establecido en el Artículo 63 de la Ley Orgánica de Trabajo de los Trabajadores y Trabajadoras, y las cláusulas 18 y 19 de la vigente Convención Colectiva de Trabajo para la Rama de la Industria de la Construcción, conexos, afines y similares de la República Bolivariana de Venezuela, el cual se regirá por las Cláusulas que se estipulan a continuación:

PRIMERA: OBJETO Y MODALIDAD. Este contrato se celebra bajo la modalidad de OBRA DETERMINADA (Arts. 63, 75 y 77 literal "a" de la LOTTT), específicamente para la ejecución de la fase técnica de: {{CONTRATO_FASE_TECNICA}}, dentro de la obra denominada: {{OBRA_NOMBRE}}. LA ENTIDAD DE TRABAJO tiene como objeto la explotación de actividades comerciales y de la industria de la construcción, y a tales efectos contrata a {{EMPLEADO_DENOMINACION}} para que desempeñe el cargo de: {{CONTRATO_CARGO_OFICIO}}, cargo establecido en el Tabulador de Oficios y Salarios Básicos de la Convención Colectiva vigente. {{EMPLEADO_DENOMINACION}} se obliga a: {{CONTRATO_OBLIGACIONES_TRABAJADOR}}

SEGUNDA: PERIODO DE PRUEBA. Conforme al Art. 25 del Reglamento de la LOTTT, se acuerda un PERIODO DE PRUEBA DE NOVENTA (90) DÍAS. Durante este lapso, LA ENTIDAD DE TRABAJO apreciará los conocimientos y aptitudes de {{EMPLEADO_DENOMINACION}}. Cualquiera de las partes podrá dar por extinguida la relación sin lugar a indemnización alguna.
...
CUARTA: JORNADA, HORARIO Y RENDIMIENTO. La jornada semanal será de cuarenta (40) horas de trabajo efectivo: {{CONTRATO_HORARIO_CUARTA}} CONTROL: {{EMPLEADO_DENOMINACION}} debe firmar diariamente su registro de avance en el Libro de Obra. La inobservancia del horario en 4 oportunidades en un mes o la negativa a firmar el registro constituirá falta grave (Art. 102 literal "i" LOTTT).
...
SEXTA: INGRESO INTEGRAL INDEXADO. {{EMPLEADO_DENOMINACION}} devengará los siguientes conceptos pagaderos en Bolívares.
...
POR LA ENTIDAD DE TRABAJO                          {{EMPLEADO_DENOMINACION_FIRMA}}
