...
CUARTA: REMUNERACIÓN. EL EMPLEADOR pagará a EL TRABAJADOR un salario básico diario de {{CONTRATO_SALARIO_DIARIO_VES}} bolívares ({{CONTRATO_SALARIO_DIARIO_VES_NUM}}), en la forma de pago {{CONTRATO_FORMA_PAGO}}{{CONTRATO_LUGAR_PAGO_LINEA}}.

QUINTA: FECHA DE INGRESO. EL TRABAJADOR ingresará a laborar a partir del {{CONTRATO_FECHA_INGRESO}}.

SEXTA: OBLIGACIONES GENERALES. EL TRABAJADOR se compromete a cumplir el reglamento interno, normas de higiene y seguridad, y las instrucciones legítimas de EL EMPLEADOR.

SÉPTIMA: CONFIDENCIALIDAD. EL TRABAJADOR guardará confidencialidad respecto de la información técnica y comercial de EL EMPLEADOR que llegue a conocer con motivo de su labor.
